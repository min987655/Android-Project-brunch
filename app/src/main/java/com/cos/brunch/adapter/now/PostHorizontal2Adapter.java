...
public class PostHorizontal2Adapter extends RecyclerView.Adapter<PostHorizontal2Adapter.MyViewHolder> {
...
//    public PostHorizontal1Adapter(List<PostRespDto> postRespDtos) {
...
//        View view = inflater.inflate(R.layout.item_now_post_horizontal, parent, false);
//        return new MyViewHolder(view);
    ...
    public void setPostByTagRespDto(List<PostByTagRespDto> postByTagRespDtos){
        ...
        postByTagRespDtoItem.add(new PostByTagRespDto("어린이와 강아지와 집","어느날","https://t1.daumcdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/3iPJ/image/PDwgaZrxak8sq8wq9ikL4Kn8CqM.jpg","오전 산책을 어쩌다 빡세게 했다. 오늘은 요술상자와 함께~ 어제와 같은 코스로 가다가 갈림길에서 다른 곳으로 가봤다. 사실 어제는 어느 정도 가다 뒤돌아 나왔는데 오늘은 그냥 가보자 싶어서 쭉 갔다.","2020-02-25 18:10:00.000000","길여행가","그림웹툰"));
        postByTagRespDtoItem.add(new PostByTagRespDto("여행지에서의 조식","소노문단양","https://t1.daumcdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/I5V/image/ye_widPHN2ZVHflrcWqz4RaUTTI.jpg","나보다 늦게 일어나던 습관을 이기고 나를 깨운다. 아침을잘 먹지 않던 습관을 깨뜨리고 꼬박꼬박 챙겨 먹는다. 평소엔 먹지도 않던 맛없는 빵과 볶음밥, 감자튀김, 베이컨 등으로 인하여 과식을 한다. 나도 덩달아 과식한다.","2020-02-25 18:10:00.000000","드루","그림웹툰"));
        postByTagRespDtoItem.add(new PostByTagRespDto("딴상","오래오래","https://t1.daumcdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/4Led/image/tnVeLuxFAnnqIRj2n1C5GkAyjcE.jpg","어느 날은 집에 다와 현관문 밖까지 나온 엄마와 마주쳤는데 엄마가 날 보고 깜짝 놀라 해 같이 놀랬다. 내 문자를 받고 현관문 뒤 숨으려다가 나와 마주친 것이다.","2020-05-17 21:34:00.000000","박다빈","그림웹툰"));
        postByTagRespDtoItem.add(new PostByTagRespDto("17년 된 샤프에 대한 단상","","https://t1.daumcdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/1aBA/image/EIv5-SwZruMZJY8ux0d0xRFvYVw.JPG","마음이 불안할 때 가끔 샤프 말고 연필이 땡긴다. 매끈하게 정제된 디자인에 심 갈아 끼우면서 쓰기 쉽게 사용할 수 있는 샤프보다, 투박한 모습에 관리가 필요해 보이는 연필 한 자루에 마음이 간다. 연필 한 자루 손에 꼭 쥐고서 종이에다가 하고 싶은 말을 끄적끄적거리면 토닥토닥 마음 깊숙이 위로를 받는다.","2020-08-02 10:14:00.000000","허지영","그림웹툰"));
