...
public class ApplyHorizontal2Adapter extends RecyclerView.Adapter<ApplyHorizontal2Adapter.MyViewHolder> {
    ...
    public void setUser(List<User> users){
        ...
        UserItem.add(users.get(13));
        UserItem.add(users.get(12));
        UserItem.add(users.get(1));
        UserItem.add(users.get(6));
        UserItem.add(users.get(10));
        UserItem.add(users.get(2));
        UserItem.add(users.get(5));
        UserItem.add(users.get(14));
        UserItem.add(users.get(3));
        UserItem.add(users.get(9));
        UserItem.add(users.get(16));
        this.users = UserItem;
